...
int main( int argc, char* args[] )
{
	...
	else
	{
		...
		else
		{
            ...
            int w=0,h=0;
            personaje = IMG_LoadTexture(gRenderer,"personaje.png");
            ...
            npc;
            npc = IMG_LoadTexture(gRenderer,"npc.png");
            SDL_QueryTexture(npc, NULL, NULL, &w, &h);
            rect_npc.x = 0;
            rect_npc.y = 0;
            rect_npc.w = w;
            rect_npc.h = h;
			...
			while( !quit )
			{
				...
				SDL_RenderCopy(gRenderer, personaje, NULL, &rect_personaje);
				SDL_RenderCopy(gRenderer, npc, NULL, &rect_npc);
